...
export default function Faq() {
  return (
    <main>
      <Helmet>
        <title>FAQ — PT Sukses Ekspor Mandiri</title>
        <meta name="description" content="Answers about MOQ, lead time, packaging, private label, shipping terms, and payment for Indonesian spice export orders." />
      ...
      <section className="py-16 lg:py-24">
        <div className="container-site max-w-3xl">
          ...
          <Reveal className="mt-12 rounded-3xl bg-secondary p-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Our export team is happy to help — usually within 24 hours.</p>
          </Reveal>
        </div>
      </section>
