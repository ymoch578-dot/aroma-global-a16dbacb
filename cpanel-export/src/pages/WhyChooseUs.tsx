...
import { Truck, Gem, BadgeDollarSign, FileCheck, Package, MessageSquare, Zap, Handshake } from "lucide-react";
...
export default function WhyChooseUs() {
  return (
    <main>
      <Helmet>
        <title>Why Choose Us — PT Sukses Ekspor Mandiri</title>
        <meta name="description" content="Reliable supply chain, premium quality selection, export documentation support, and responsive service — why global buyers choose us." />
      </Helmet>
      ...
      <section className="bg-muted py-20 lg:py-24">
        <div className="container-site max-w-3xl text-center">
          <Reveal>
            ...
            <h2 className="mt-4 font-display text-3xl font-bold text-foreground">Transparent From First Inquiry to Final Delivery</h2>
            <p className="mt-5 leading-relaxed text-muted-foreground">
              We don't hide behind vague claims. You get honest specifications, clear pricing, real photos and samples of the actual lot, and proactive updates throughout production and shipping.
            </p>
          </Reveal>
        </div>
      </section>
