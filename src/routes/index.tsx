  ...
  return (
    <main>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        <img
          src={heroImg}
          alt="Premium Indonesian spices — cinnamon, clove, nutmeg, and pepper"
          width={1920}
          height={1080}
        ...
        <div className="container-site relative z-10 py-40 text-center text-primary-foreground">
          ...
          <motion.h1
            ...
            className="mx-auto mt-5 max-w-4xl font-display text-4xl font-bold leading-[1.1] sm:text-5xl lg:text-7xl"
          >
          ...
          <motion.p
            ...
            className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-primary-foreground/85 lg:text-lg"
          >
            Supplying premium-quality Indonesian spices to importers and food industries
            worldwide with consistent quality, competitive pricing, and reliable export
            services.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            ...
            <Link
              to="/products"
              className="rounded-full border border-primary-foreground/40 px-8 py-4 text-sm font-semibold text-primary-foreground backdrop-blur-sm transition-colors hover:bg-primary-foreground/10"
            >
      ...
      <section className="bg-muted py-20 lg:py-28">
        <div className="container-site">
          ...
          <Reveal className="mt-10 text-center">
            <Link
              to="/products"
              className="inline-flex items-center gap-2 rounded-full border border-primary px-7 py-3.5 text-sm font-semibold text-primary transition-colors hover:bg-primary hover:text-primary-foreground"
            >
